...
import { getDashboardSummary } from "@/lib/bff/payments-api";
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const data = await getDashboardSummary(context, {
    ...
    return toBffErrorResponse(error, "Falha ao consultar o resumo da dashboard.", correlationId);
  }
}
